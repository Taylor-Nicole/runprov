...
`tests/test_runprov.py`, 550 tests, all of which import `runprov` and exercise the real
...
Twenty-two of the 550 need something of the filesystem itself — a FIFO, a symlink, a file
