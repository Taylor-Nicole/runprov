...
`tests/test_runprov.py`, 545 tests, all of which import `runprov` and exercise the real
...
Twenty-two of the 545 need something of the filesystem itself — a FIFO, a symlink, a file
